...
public struct LockOptions: LockDataSource, LockDelegate {
    ...
    /// 连线线条宽度
    public var lockLineWidth: CGFloat = 2 {
        willSet {
            LockManager.options.lockLineWidth = newValue
        }
    }
    ...
    /// 背景色
    public var backgroundColor = rgba(255, g: 255, b: 255, a: 0) {
        willSet {
    ...
    /// 外环线条颜色：默认
    public var circleLineNormalColor = rgba(20, g: 162, b: 218, a: 1) {
        willSet {
    ...
    /// 外环填充颜色：默认
    public var circleInfillColor = rgba(255, g: 255, b: 255, a: 0.3) {
        willSet {
            LockManager.options.circleInfillColor = newValue
        }
    }
    ...
    /// 普通文字颜色
    public var normalTitleColor = rgba(254, g: 254, b: 254, a: 1) {
        willSet {
    ...
    ///背景图片
    public var backgroundImageName = "GestLockBackImage" {
        willSet {
            LockManager.options.backgroundImageName = newValue
        }
    }
