...
//            url = "Account/CheckWechat"
        ...
        //验证码框、真实姓名、密码、性别、生日,无需请求网络验证
        if textField.tag == RegisterTag.verifyText.rawValue || textField.tag == RegisterTag.realNameText.rawValue || textField.tag == RegisterTag.passwordText.rawValue || textField.tag == RegisterTag.genderText.rawValue || textField.tag == RegisterTag.birthdayText.rawValue || textField.tag == RegisterTag.wechatText.rawValue {
            success()
            return
        }
...
//    }
    ...
    func btnAct(btnTag: Int) {
        ...
        case RegisterTag.maleBtnTag.rawValue:
            ...
            maleLabel.textColor = UIColor.colorWithCustom(r: 0, g: 101, b: 215)
            femaleLabel.textColor = UIColor.colorWithCustom(r: 81, g: 81, b: 81)
            self.isMale = true
        case RegisterTag.femaleBtnTag.rawValue:
            ...
            femaleLabel.textColor = UIColor.colorWithCustom(r: 0, g: 101, b: 215)
            maleLabel.textColor = UIColor.colorWithCustom(r: 81, g: 81, b: 81)
...
//        }
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        if currentTextField != nil {
            currentTextField.resignFirstResponder()
//            self.registerView.frame = CGRect(x: 0, y: 0, width: self.registerView.frame.width, height: self.registerView.frame.height)
