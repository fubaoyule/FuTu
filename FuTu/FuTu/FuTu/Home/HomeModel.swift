...
enum HomeTag:Int {
    ...
    case totleAccountLabel = 20
    
    case gameVeiwTag = 30, gameBtnTag
    case loginRegisterViewTag = 50, loginBtnTag, registerBtnTag
    case giftBoxBtnTag = 60, treasureBoxBtnTag, redPacketBtnTag, lotteryBtnTag
...
class HomeModel: NSObject {
    ...
    //通知栏的字体颜色
    let noticeTextColer = UIColor.colorWithCustom(r: 193, g: 193, b: 193)
    //通知栏的字体大小
    let noticeTextFont: CGFloat = 12
    //通知栏的背景颜色
    let noticeBackColor = UIColor.colorWithCustom(r: 53, g: 61, b: 82)
    //通知滚动时间
    ...
    //首页总金额字体的颜色
    let amountTextColor = UIColor.colorWithCustom(r: 35, g: 35, b: 35)
    //首页总金额字体的大小
    ...
    //增加游戏需要修改
    //游戏按钮的图片
    let gameImg = ["home_game_newPT.png","home_game_MG.png","home_game_AG.png","home_game_AGFish.png", "home_game_SG.png", "home_game_PNG.png","home_game_HB.png", "home_game_TTG.png","home_game_bs.png"]
    ...
    //增加游戏需要修改
    let gameKey = ["mg","ag","agfish","sg","png","hb","ttg","bs"]
