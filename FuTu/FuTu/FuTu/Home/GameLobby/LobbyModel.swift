...
class LobbyModel: NSObject {
    ...
    //充值按钮颜色
    let rechargeBtnColor = UIColor.colorWithCustom(r: 27, g: 123, b: 233)
    let rechargeTextColor = UIColor.colorWithCustom(r: 255, g: 255, b: 255)
    //充值按钮字体大小
    ...
    let gameIconArray = ["lobby_ico_MG.png","lobby_ico_AG.png","lobby_ico_AGFish.png","lobby_ico_SG.png","lobby_ico_PNG.png","lobby_ico_HB.png","lobby_ico_TTG.png","lobby_ico_BS.png"]
