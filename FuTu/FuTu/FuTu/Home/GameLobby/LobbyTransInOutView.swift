...
class LobbyTransInOutView:  UIView {
    ...
    func addAlertView() -> UIView {
        ...
        setLabelProperty(label: titleLabel, text: "\(self.transferType)\(self.gameName!)", aligenment: .center, textColor: .colorWithCustom(r: 0, g: 101, b: 215), backColor: .white, font: fontAdapt(font: isPhone ? 17 : 12))
        //close button
        ...
        pickerConfirmBtn = baseVC.buttonCreat(frame: confirmFrame, title: "确认\(self.transferType)", alignment: .center, target: self, myaction: #selector(self.btnAct(sender:)), normalImage: nil, hightImage: nil, backgroundColor: .colorWithCustom(r: 27, g: 123, b: 233), fonsize: fontAdapt(font: isPhone ? 20 : 12), events: .touchUpInside)
