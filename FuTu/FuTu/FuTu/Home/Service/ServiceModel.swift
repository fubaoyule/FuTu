...
//    let answerInfo = [
//                      [["",""]],
//                      [["如何注册富途娱乐账户？","您只需要简单一步，即可以拥有一个富途娱乐账户。点击网站首页上方“免费注册”或登录窗口下方的“没有账号？免费注册体验”，在弹出的注册表内输入您的用户名、密码、电子邮箱及个人资料并提交后就可以完成开户。请留意：用户名长度须为6~12位字符，由数字、字母及下划线组成，密码长度须为6~12位字符为数字和字母组合；注册前，请务必确认您已满18周岁并已阅读过我们的服务条款和隐私政策。"],
...
//                      [["",""]]]
    ...
    let answerInfo = [[["如何存款？","登录您的富宝账户，然后点击首页上方的”存款“，选择微信、支付宝、在线充值或网银充值，填写存款金额提交后完成支付操作即可。"],
                      ...
                      [["如何开设账户?","开设账户只需点击网站首页右上方“立即注册”，在弹出的注册表内输入您的用户名、密码、真实姓名、手机号、电子邮箱进行资料并提交后就可以完成开户。请留意：用户名长度须为6~12位字符，由数字、字母及下划线组成，密码长度须为6~12位字符为数字和字母组合；注册前，请务必确认您已满18周岁并已阅读过我们的服务条款和隐私政策。"],
                       ["同一个用户可否同时使用多个账号吗？","富宝规定同一会员只能使用一个账号，如发现客户拥有多个户口，公司有权取消其账号以及投注所获得的盈利,同时保留取消或关闭您的账户权利，有权限制客户只保留其中一个户口。"],
                       ...
                       ["允许我在富宝开户游戏吗？","在您注册和投注前，请务必确保您已年满18周岁并同意我们的服务条款和隐私政策。不同的国家或地区有不同的监管条例，请在投注前遵循当地法规与法律。"],
                       ["哪些地区或国家不能在富宝注册？","以下地区或国家：菲律宾、马来西亚、香港、台湾、新加坡、美国及加拿大不被接受注册开户。"]],
                      [["在富宝交易合法吗？","富宝是一家拥有合法牌照的正规公司，在此交易都会受执照监管机构的法律保护。有的国家或地区当地法律禁止博彩，阁下有责任确保当地法律接受相关投注和游戏，并且不会阻止您在我们公司注册开户，富宝不接受亦不受理因此引起的任何法务问题。"],
                       ["在这里开户注册，资料安全有保障吗？","会员的注册和交易资料都是通过加密处理，富宝承诺绝对不会泄露您的个人资料给任何第三方，除非收到法庭传单或可行性法律的要求及判决。"],
                       ["网站是否有加密机制？","所有用户提供的个人信息，其传送都将通过安全端口（SSL 128 bit encryption Standard）并存放在公众无法进入的保密环境之下。所有数据的内部出入都受到限制及严密的监控，确保会员信息安全，请您放心！."]],
                      [["怎样转账到娱乐场？","登陆富宝账号后，进入中心钱包，然后在对应的娱乐场平台“转入”/“转出”功能中操作即可。"],
                       ["投注出错或投诉结算有误？","通过在线客服或者发送邮件到cs@toobet.com联系我们的客服人员查询，并提供以下信息：您的富宝账号和游戏详情（包括：娱乐场名称、游戏名称、投注编号、金额、时间）以便我们的工作人员为您核实查询。"],
