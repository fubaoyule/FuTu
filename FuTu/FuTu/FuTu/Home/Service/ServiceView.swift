...
//        questionView = UIView(frame: CGRect(x: 0, y: adapt_H(height: model.bannerHeight + model.viewDistance), width: width, height: adapt_H(height: model.questionHeight)))
        ...
        searchView.layer.borderColor = UIColor.colorWithCustom(r: 27, g: 123, b: 233).cgColor
        ...
        let searchBtn = baseVC.buttonCreat(frame: buttonFrame, title: "搜 索", alignment: .center, target: self, myaction: #selector(self.btnAct(sender:)), normalImage: nil, hightImage: nil, backgroundColor: .colorWithCustom(r: 27, g: 123, b: 233), fonsize: fontAdapt(font: isPhone ? 16 : 12), events: .touchUpInside)
