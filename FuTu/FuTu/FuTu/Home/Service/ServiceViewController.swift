...
class ServiceViewController: UIViewController, UIScrollViewDelegate,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource, serviceDelegate {
    ...
    func serviceBtnAct(btnTag: Int) {
        ...
        case serviceTag.OnlineServiceBtn.rawValue:
            ...
            onlineService.param = ["gameType":"service", "orientation":"portrait", "url":"http://i.toobet.co/GD"] as AnyObject
...
//        }
        ...
        
    {
        ...
        let atrributes = NSAttributedString(string: self.ctrlsel[indexPath.row][1] , attributes: [NSParagraphStyleAttributeName:paragraphStyle])
