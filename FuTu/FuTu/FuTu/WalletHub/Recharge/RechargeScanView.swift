...
class RechargeScanView: UIView {
    ...
    init(frame:CGRect, payType:PayType,rootVC:UIViewController) {
        ...
        self.initScrollView {
            self.payType == PayType.UnionPay ? self.initUnionPayView() : ( self.payType == PayType.TimePay ? self.initTimePayView() : self.initScanInfoView())
        }
    ...
    func initNavigationBar() -> Void {
        ...
        let titleText = (self.payType == PayType.UnionPay ? "网银转账" : (self.payType == PayType.TimePay ? "点卡充值" : (self.payType == PayType.WeChatPay ? "微信转账" : "支付宝转账")))
        let titleLabel = UILabel(frame: CGRect(x: 0, y: 20, width: width, height: navBarHeight))
        setLabelProperty(label: titleLabel, text: titleText, aligenment: .center, textColor: .white, backColor: .clear, font: 17 )
    ...
    func initTimePayView() -> Void {
        ...
        for i in 0 ..< btnNum {
            ...
            timeCardBtn.layer.borderColor = UIColor.colorWithCustom(r: 209, g: 209, b: 209).cgColor
            ...
            if i == 0 {
                ...
                timeCardBtn.layer.borderColor = UIColor.colorWithCustom(r: 26, g: 123, b: 233).cgColor
            }
        }
        ...
        let confirmBtn = baseVC.buttonCreat(frame: confirmFrame, title: "充值确认", alignment: .center, target: self, myaction: #selector(self.btnAct(sender:)), normalImage: nil, hightImage: nil, backgroundColor: UIColor.colorWithCustom(r: 26, g: 123, b: 233), fonsize: fontAdapt(font: isPhone ? 20 : 12), events: .touchUpInside)
    ...
    func timeCardSelected(tag:Int) -> Void {
        ...
        selectedBtn.layer.borderColor = UIColor.colorWithCustom(r: 26, g: 123, b: 233).cgColor
    ...
    func initUnionPayView() -> Void {
        ...
        let payImgArray = ["wallet_recharge_unionImg.png","wallet_recharge_toImg.png","wallet_recharge_unionImg.png"]
        ...
        let confirmBtn = baseVC.buttonCreat(frame: confirmFrame, title: "充值确认", alignment: .center, target: self, myaction: #selector(self.btnAct(sender:)), normalImage: nil, hightImage: nil, backgroundColor: UIColor.colorWithCustom(r: 26, g: 123, b: 233), fonsize: fontAdapt(font: isPhone ? 17 : 11), events: .touchUpInside)
        self.scroll.addSubview(confirmBtn)
...
//        confirmBtn.isUserInteractionEnabled = false
    ...
    func initScanInfoView() -> Void {
        ...
        for i in 0 ..< 3 {
            ...
            attributedString.addAttribute(NSParagraphStyleAttributeName, value: paragraphStyle, range: NSMakeRange(0,  ((isPhone ? methodInfoArray[i][0] : methodInfoArrayPad[i][0]) as! String).characters.count))
...
//            confirmBtn.isUserInteractionEnabled = false
        ...
        attributedString.addAttribute(NSParagraphStyleAttributeName, value: paragraphStyle, range: NSMakeRange(0,  (saveText).characters.count))
    ...
    func updatePayInfo(info:Dictionary<String,Any>) -> Void {
        ...
        case PayType.WeChatPay.rawValue:
            tlPrint(message: "微信转账支付")
            keyArray = ["AccountName","Money"]
        case PayType.UnionPay.rawValue:
            tlPrint(message: "银联转账支付")
