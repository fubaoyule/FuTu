...
class GameListViewController: UIViewController,WKNavigationDelegate, UnlimitedSlideVCDelegate {
    ...
    func gameBtnAct(sender: UIButton) -> Void {
    ...
    func infoSwitchCase(type: String, tag: Int?) -> AnyObject {
        ...
        //游戏分类字典
        //增加游戏需要修改
        let navItemsDic = ["newPT":model.navItems_newPT,"BS":model.navItems_BS,"PT":model.navItems_PT,"MG":model.navItems_MG,"TTG":model.navItems_TTG,"SG":model.navItems_SG,"HB":model.navItems_HB,"PNG":model.navItems_PNG,"AG":model.navItems_AG,"AGFish":model.navItems_AGFish]
        //游戏地址字典
        //增加游戏需要修改
        let gameAddrDic = ["newPT":isRelease ? model.newPTGameAddr : model.newPTGameAddrTest,
                           ...
                           "AG":model.AGGameAddr,
                           "AGFish":model.AGGameAddr]
        //游戏资源字典
        let dataSourceDic = ["newPT":model.newPTDataSource,"BS":model.BSDataSource,"PT":model.PTDataSource,"MG":model.MGDataSource,"TTG":model.TTGDataSource,"SG":model.SGDataSource,"HB":model.HBDataSource,"PNG":model.PNGDataSource,"AG":model.AGDataSource]
        //所有游戏字典
        let navItem0Dic = ["newPT":model.navItem_newPT0,"BS":model.navItem_BS0,"PT":model.navItems_PT,"MG":model.navItem_MG0,"TTG":model.navItem_TTG0,"SG":model.navItem_SG0,"HB":model.navItem_HB0,"PNG":model.navItem_PNG0,"AG":model.navItem_AG0] as [String : Any]
