...
class ScrollViewController: UIViewController, UIScrollViewDelegate {
    ...
    func gameCellView(index: Int, pageNumber: Int) -> UIButton {
        ...
        if !isShowList {
            ...
            imgFrame = CGRect(x: adapt_W(width: 4.5), y: adapt_W(width: 4.5), width: width - adapt_W(width: 9), height: height - adapt_H(height: 32))
            
            labelFrame = CGRect(x: 0, y: height - adapt_H(height: 21), width: width, height: adapt_H(height: 15))
    ...
    //Mark:- 
    //==============================
    func prepareToGame(sender:UIButton) -> Void {
    ...
    func reloadGameList(dataArray: Array<Int>) {
        ...
        let gameType = userDefaults.value(forKey: userDefaultsKeys.gameType.rawValue) as! String
        //增加游戏需要修改
        let dataSourceDic = ["newPT":model.newPTDataSource,"BS":model.BSDataSource,"PT":model.PTDataSource,"MG":model.MGDataSource,"TTG":model.TTGDataSource,"SG":model.SGDataSource,"HB":model.HBDataSource,"PNG":model.PNGDataSource,"AG":model.AGDataSource,"AGFish":model.AGDataSource]
    ...
    func configurePageController() {
        ...
        self.pageControl?.currentPageIndicatorTintColor = UIColor.colorWithCustom(r: 70, g: 235, b: 255)
        self.pageControl?.pageIndicatorTintColor = UIColor(red: 70/255, green: 235/255, blue: 1, alpha: 0.3)
