...
enum userDefaultsKeys: String {
    ...
    //增加游戏需要修改
    case platformGame_SB = "platformGame_SB"
    case platformGame_3D = "platformGame_3D"
    case platformGame_AV = "platformGame_AV"
    case platformGame_BBIN = "platformGame_BBIN"
    case platformGame_GD = "platformGame_GD"
    case platformGame_PT = "platformGame_PT"
    case platformGame_MG = "platformGame_MG"
    case platformGame_TTG = "platformGame_TTG"
    case platformGame_AG = "platformGame_AG"
    case platformGame_AGFish = "platformGame_AGFish"
...
//正式API
//var webApi = "http://mapi.toobet.net"

//测试API
//var webApi = "http://mapi.toobet.net"

var webApi = (isRelease ? "http://mapi.toobet.net" : "http://api.toobet.com")//API


//更新动态域名和版本的固定请求域名
var dynamicDomainUrl = webApi + "/api/Mobile/GetMobileConfig"
...
//let globleGameName = ["富宝体育","BS老虎机","SG老虎机","HB老虎机","BBIN老虎机","PT老虎机","MG老虎机","TTG老虎机","PNG老虎机"]
...
//获取账户余额是的区分代码
//增加游戏需要修改
let globleGameCode = ["MG","AG","SG","PNG","HABA","TTG","BTS"]
let selfGameCode = ["MG","AG","SG","PNG","HABA","TTG","BTS"]
let gameLobbyGameCode = ["MG","AG","AG","SG","PNG","HABA","TTG","BTS"]
let homeGameCode = ["newPT","MG","AG","AG","SG","PNG","HABA","TTG","BTS"]
//游戏名称
//增加游戏需要修改
let globleGameName = ["MG老虎机","AG真人","SG老虎机","PNG老虎机","HB老虎机","TTG老虎机","BS老虎机"]
let selfGameName = ["MG老虎机","AG真人","SG老虎机","PNG老虎机","HB老虎机","TTG老虎机","BS老虎机"]
let gameLobbyGameName = ["MG老虎机","AG真人","AG捕鱼","SG老虎机","PNG老虎机","HB老虎机","TTG老虎机","BS老虎机"]
let homeGameName = ["PT旗舰版","MG老虎机","AG真人","AG捕鱼","SG老虎机","PNG老虎机","HB老虎机","TTG老虎机","BS老虎机"]
//增加游戏需要修改
let globleGameUserDefaults = ["platformGame_newPT","platformGame_MG","platformGame_AG","platformGame_AG","platformGame_SG","platformGame_PNG","platformGame_HB","platformGame_TTG","platformGame_BS"]
let selfGameUserDefaults = ["platformGame_MG","platformGame_AG","platformGame_SG","platformGame_PNG","platformGame_HB","platformGame_TTG","platformGame_BS"]
let gameLobbyGameUserDefaults = ["platformGame_MG","platformGame_AG","platformGame_AG","platformGame_SG","platformGame_PNG","platformGame_HB","platformGame_TTG","platformGame_BS"]
//*********************************************************
//         富途体育网络请求函数
//*********************************************************
...
//*********************************************************
//         富途体育网络请求函数,Get请求，收到Data转换为String
//*********************************************************
