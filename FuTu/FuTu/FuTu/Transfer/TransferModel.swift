...
class TransferModel: NSObject {
    ...
    let withdrawBtnColor = UIColor.colorWithCustom(r: 50, g: 185, b: 183)
     ...
     let imgName = isPhone ? ["transfer_view_MG.png","transfer_view_AG.png","transfer_view_SG.png","transfer_view_PNG.png","transfer_view_HB.png","transfer_view_TTG.png","transfer_view_BS.png"] : ["transfer_view_newPT_Pad.png","transfer_view_MG_Pad.png","transfer_view_AG_Pad.png","transfer_view_SG_Pad.png","transfer_view_PNG_Pad.png","transfer_view_HB_Pad.png","transfer_view_TTG_Pad.png","transfer_view_BS_Pad.png"]
