...
class BankView: UIView, UIPickerViewDelegate,UIPickerViewDataSource,UIAlertViewDelegate {
    ...
    func initNavigationBar() -> Void {
        ...
        setLabelProperty(label: titleLabel, text: "个人资料", aligenment: .center, textColor: .white, backColor: .clear, font: 17)
...
//            showNum.append(carNum.substring(from: carNum.index(carNum.startIndex, offsetBy: 12)))
        ...
        addBtn.backgroundColor = UIColor.colorWithCustom(r: 27, g: 123, b: 233)
...
//            })
    ...
    func addBankAlertView() -> UIView {
        ...
        setLabelProperty(label: titleLabel, text: "绑定银行卡", aligenment: .center, textColor: .colorWithCustom(r: 0, g: 101, b: 215), backColor: .white, font: fontAdapt(font: isPhone ? 17 : 12))
        //close button
...
//                selectBtn.backgroundColor = UIColor.yellow
        ...
        let confirmBtn = baseVC.buttonCreat(frame: confirmFrame, title: "确 定", alignment: .center, target: self, myaction: #selector(self.alertBtnAct(sender:)), normalImage: nil, hightImage: nil, backgroundColor: .colorWithCustom(r: 27, g: 123, b: 233), fonsize: fontAdapt(font: 20), events: .touchUpInside)
    ...
    func alertBtnAct(sender:UIButton) -> Void {
