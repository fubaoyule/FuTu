...
//        self.refreshPull()
    ...
    //消息通知改变中心钱包金额
    func selfModifyAccountLabel(sender:Notification) -> Void {
    ...
    func buttonAction(btnTag: Int) {
        ...
        self.checkLoginStatus {
            ...
            case selfBtnTag.MessageBtn.rawValue:
                ...
                //            if userDefaults.value(forKey: userDefaultsKeys.messageInfo.rawValue) == nil {
            ...
            default:
                if btnTag >= selfBtnTag.SelfGameBtnTag.rawValue && btnTag < selfBtnTag.AccountLabel.rawValue {
                    ...
                    var gameIndex = btnTag - selfBtnTag.SelfGameBtnTag.rawValue
                    if gameIndex >= 2 {
                        gameIndex+=1
                    }
